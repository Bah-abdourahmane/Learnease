...
@section('content')
    <div class=" bg-third text-white relative">
        @if (@session('success'))
            <div class="duration-300 absolute top-2 right-2 min-w-20 rounded bg-green-500 p-3 mb-3">{{ session('success') }}
            </div>
        @endif
        {{-- banner --}}
            ...
            <div class="lg:pl-20 flex flex-col justify-between h-full pb-10">
                <div class="max-w-2xl">
                    ...
                    <p class="font-bold uppercase  py-5">
                        Approved : <span class="font-normal">{{ $course->is_approved ? 'Yes' : 'Not yet' }}</span>
                    </p>
